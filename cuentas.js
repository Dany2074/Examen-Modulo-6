...
const agregarGasto = (body) => {
  ...
  let roommateData = roommateView.roommates; //datos de las personas
  let roommateCount = roommateData.length; //cantidad total de personas

  // Comparamos  quien hizo el pago con los otros roommies y luego calcula cuanto debe y recibe
  roommateData.map((e) => {
...
//Función que  modificar las cuentas correspondientes a los gastos realizados por los roommates
